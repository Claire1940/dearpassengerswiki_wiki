...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.dearpassengerswiki.wiki'
  const path = '/about'

  return {
    title: 'About Dear Passengers Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Dear Passengers Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Dear Passengers Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Dear Passengers Wiki',
      title: 'About Dear Passengers Wiki',
      description: 'Learn about our mission to provide the best Dear Passengers game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Dear Passengers Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Dear Passengers Wiki',
      description: 'Learn about our mission to provide the best Dear Passengers game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Dear Passengers Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Dear Passengers
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Dear Passengers Wiki</h2>
            <p>
              Dear Passengers Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "Dear Passengers". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Dear Passengers Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Dear Passengers players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Dear Passengers Wiki as the <strong>go-to destination</strong> for every Dear Passengers player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Dear Passengers Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Dear Passengers Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Dear Passengers as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Dear Passengers mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Dear Passengers Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Dear Passengers or any official entities.
            </p>
            <p>
            ...
            <p>
              Dear Passengers Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@dearpassengerswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@dearpassengerswiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@dearpassengerswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@dearpassengerswiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@dearpassengerswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@dearpassengerswiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@dearpassengerswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@dearpassengerswiki.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Dear Passengers news.
